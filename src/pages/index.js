...
export default function Home() {
  ...
  const fetchData = async () => {
    const url = "https://script.google.com/macros/s/AKfycbyEtdhDysTqbR_ZMPpt3vDOaS4LMXDmrvfHRSeAHuZjIlEFfj3dKJCztaF4ErR8ZlMW-w/exec?action=getUsers";
...
<div className="flex justify-center items-center">
  ...
  <Headder/>
      ...
      <div className="w-full bg-[#fff] h-[550px] ">
        ...
        <img src="https://cdn.shopify.com/s/files/1/0624/7949/9512/files/graphicscards_1024x1024.jpg?v=1648720902" alt="" className=" w-full h-full"/>
      </div>
      <div className="w-full bg-[#fff] h-[550px]">
