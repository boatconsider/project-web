...
export default function Headder(){
    ...
    return(
        ...
        <div className="flex flex-row items-center ml-3 text-[#fff] text-xl justify-between">
          <div className="flex flex-row items-center cursor-pointer text-blue-500" onClick={() => router.push('/')}>
            <RiComputerLine />
          ...
          <div className="flex items-center flex-row mr-3 outline-none border-none md:m-0">
            ...
            <div className="max-[650px] hidden md:flex md:p-0  ">
              <button className="text-[#fff] hover:bg-[#06b6d4] hover:text-[#fff] p-1 mr-2 rounded-md flex items-center outline-none" onClick={() => router.push('/')}>
                <AiOutlineHome />
                หน้าหลัก
              </button>
              ...
              <button className="text-[#fff] hover:bg-[#06b6d4] hover:text-[#fff] p-1 mr-2 rounded-md flex items-center outline-none" onClick={() => router.push('/login')}>
                <AiOutlineLogin />
                เข้าสู่ระบบ
              </button>
              <button className="text-[#fff] hover:bg-[#06b6d4] hover:text-[#fff] p-1 mr-2 rounded-md flex items-center outline-none" onClick={() => router.push('/signup')}>
                <TbLogin />
                สมัครสมาชิก
              </button>
            </div>
